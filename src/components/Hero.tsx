          ...
          <div className="relative animate-fade-in order-1 lg:order-2">
            <div className="relative max-w-lg mx-auto lg:max-w-2xl">
              ...
              <div className="relative bg-white p-4 sm:p-6 lg:p-8 rounded-2xl shadow-2xl border border-border/50">
                <div className="w-full h-[31rem] bg-gradient-to-br from-secondary to-accent rounded-xl flex items-center justify-center overflow-hidden">
                  <video 
                    ...
                    muted
                    playsInline
                    className="w-full h-full object-cover rounded-xl transform -translate-y-4"
                  >
