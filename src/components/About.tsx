          ...
          <div className="relative animate-fade-in">
            <div className="relative max-w-lg mx-auto lg:max-w-2xl">
              ...
              <div className="relative bg-white p-4 sm:p-6 lg:p-8 rounded-2xl shadow-2xl border border-border/50">
                <div className="w-full h-[24rem] sm:h-[28rem] lg:h-[32rem] bg-gradient-to-br from-secondary to-accent rounded-xl flex items-center justify-center overflow-hidden">
                  <video 
