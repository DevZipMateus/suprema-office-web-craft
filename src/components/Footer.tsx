...
const Footer = () => {
  ...
  return (
    <footer className="bg-primary text-primary-foreground">
      <div className="container-suprema section-padding-sm">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-6">
              ...
              />
              <div>
                <h3 className="text-lg font-bold">Suprema Office</h3>
                <p className="text-sm opacity-90">Mobiliário Corporativo</p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <a 
                ...
                className="flex items-center space-x-3 text-sm opacity-90 hover:opacity-100 transition-opacity"
              >
              ...
              <a 
                ...
                className="flex items-start space-x-3 text-sm opacity-90 hover:opacity-100 transition-opacity"
              >
          ...
          <div>
            <h4 className="font-semibold mb-4">Funcionamento</h4>
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center space-x-2 text-sm opacity-90 hover:opacity-100 transition-opacity"
            >
